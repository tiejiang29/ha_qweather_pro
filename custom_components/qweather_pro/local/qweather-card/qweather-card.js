/**
 * QWeather Dashboard Card - Pro (2026.6)
 */
...
(async () => {
  ...
  class QWeatherCard extends Lit {
    static get properties() {
      return {
        hass: {}, config: {}, _forecastDaily: {}, _forecastHourly: {},
        _weather: {}, _selectedTab: {}, _lang: {}
      };
    }
    ...
    render() {
      ...
      const aqiCat = a.aqi?.aqi_category || "";
          ...
          <div class="briefing-box">
            ...
            <div class="brief-item">
              ...
              <div class="brief-content">
                ...
                <span class="brief-value">${a.hourly_summary || this._t("stable_weather")}</span>
              </div>
            </div>
          </div>
    ...
    static get styles() {
      return css`
        ...
        .warning-section {
          color:#333; padding:10px; border-radius:8px; margin-bottom:16px;
          display:flex; gap:10px; border:1px solid rgba(0,0,0,.1);
        }
        .warning-text {
        ...
        .briefing-box {
          background:var(--secondary-background-color); padding:12px; border-radius:10px;
